...
eliminationOfDoubleNegative (Unary '!' (Unary '!' a)) = a
eliminationOfDoubleNegative f = f

deMorgansLawAnd (Unary '!' (Binary '&' a b)) = Binary '|' (Unary '!' a) (Unary '!' b)
deMorgansLawAnd f = f

deMorgansLawOr (Unary '!' (Binary '|' a b)) = Binary '&' (Unary '!' a) (Unary '!' b)
deMorgansLawOr f = f

materialCondition (Binary '>' a b) = Binary '|' (Unary '!' a) b
materialCondition f = f

-- Equivalence' to match example and remove unwanted '>' operations (A&B)|((!A)&(!B))
equivilence' (Binary '=' a b) = Binary '|' (Binary '&' a b) (Binary '&' (Unary '!' a) (Unary '!' b))
equivilence' f = f

distributivityAnd (Binary '&' a (Binary '|' b c)) = Binary '|' (Binary '&' a b) (Binary '&' a c)
distributivityAnd f = f

distributivityOr (Binary '|' a (Binary '&' b c)) = Binary '&' (Binary '|' a b) (Binary '|' a c)
distributivityOr f = f
